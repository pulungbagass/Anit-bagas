/* =========================================
   ...
   Fungsi di-export supaya bisa di-import
   dari module lain (misal password.js).
========================================= */
const BIRTHDAY_COLORS = ["#f4c869", "#ff9ecb", "#c9aaff", "#fdf6ec"];

// ===== Ambient fireflies (jalan terus, halus) =====
export function initBirthdayFireflies() {
  ...
  for (let i = 0; i < FIREFLY_COUNT; i++) {
    ...
    const color =
      BIRTHDAY_COLORS[Math.floor(Math.random() * BIRTHDAY_COLORS.length)];
